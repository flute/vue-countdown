...
var OPENING = 2;
var CLOSED = 3;
var TIPS = (_TIPS = {}, _defineProperty(_TIPS, NOTOPEN, 'Left at the beginning:'), _defineProperty(_TIPS, OPENING, 'Left at the end:'), _defineProperty(_TIPS, CLOSED, 'Over:'), _TIPS);
var SECOND = 1000;
...
/* harmony default export */ var src = ({
  ...
  methods: {
    ...
    init: function init() {
      ...
      var startTime = this.startTime,
          ...
          notOpenTip = this.notOpenTip,
          openingTip = this.openingTip,
          closedTip = this.closedTip;
      ...
      this.durations = duration; // custom tips

      var tips = (_tips = {}, _defineProperty(_tips, NOTOPEN, notOpenTip), _defineProperty(_tips, OPENING, openingTip), _defineProperty(_tips, CLOSED, closedTip), _tips);
    ...
    countdownTask: function countdownTask() {
      ...
      if (leftTime > 0) {
        ...
        if (Math.abs(leftTime) < duration) {
          ...
          // closed
          doTask = false;
          this.status = CLOSED; // clear setInterval task
   ...
   */
  watch: {
    remainingTime: function remainingTime(newTime) {
      if (newTime < SECOND) {
